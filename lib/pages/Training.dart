        ...
        slivers: [
          ...
          SliverList(
            delegate: SliverChildListDelegate([
              Container(
                child: Image(
                  image: AssetImage("images/courses.png"),
                ),
              ),
              Row(
                children: [
              ...
              Padding(
                ...
                child: Container(
                  ...
                  child: Padding(
                    padding: const EdgeInsets.all(8.0),
                    child: Text(
                      "Apple Beauty Care at Madurai is the Professional cosmetology training center. Apple Beauty Care is exclusive for ladies, those who are looking for excellent career and self employment.",
                      style: GoogleFonts.roboto(
                        fontWeight: FontWeight.bold,
                        fontSize: 15,
                        color: Colors.green,
              ...
              Padding(
                ...
                child: Container(
                  ...
                  child: Padding(
                    padding: const EdgeInsets.all(8.0),
                    child: Text(
                      "Apple Beauty Care provides an environment for beauty industry professionals who love their work, have an interest in growing their business, and who strive to provide excellence in service and personal relationships.",
                      style: GoogleFonts.roboto(
                        fontWeight: FontWeight.bold,
                        fontSize: 15,
                        color: Colors.green,
              ...
              Padding(
                ...
                child: Container(
                  ...
                  child: Padding(
                    padding: const EdgeInsets.all(8.0),
                    child: Text(
                      "The atmosphere is upbeat with a great vibe and energy while remaining fashion focused and professional. Members of our team enjoy career path coaching, excellence in salon education from our industry’s most prestigious trainers, and accountability to each other. If you have a great personality and attitude, strong people skills, and love the beauty industry, we want to meet you.",
                      style: GoogleFonts.roboto(
                        fontWeight: FontWeight.bold,
                        fontSize: 15,
                        color: Colors.green,
